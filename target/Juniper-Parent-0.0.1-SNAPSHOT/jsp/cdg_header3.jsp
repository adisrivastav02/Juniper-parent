...
<body>
  <div class="container-scroller" style="background-image:url('${pageContext.request.contextPath}/assets/img/bg2.jpg');" >
    ...
    <div class="row">
     <div class="col-md-11" style="text-align:center;padding-top:20px;color:white;"> <h2>INFOGRID  Platform Capabilities</h2>
     
     </div>
      <div class="col-md-1" style="text-align:center;padding-top:20px;color:white;"><h4 style="text-align: right;">
